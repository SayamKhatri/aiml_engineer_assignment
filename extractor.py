...
#     user_name: str | None = Field(None, description="Full Name or null if not mentioned")
#     category: str = Field(description="One of the 5 predefined categories")
...
# 2. Classify the query into exactly ONE of these 5 categories:

# 1. Travel & Accommodation - hotels, flights, villas, itineraries, trip bookings, or travel arrangements.
# 2. Dining & Experiences - restaurant bookings, concerts, cultural or social events, entertainment, or art-related experiences.
# 3. Personal & Wellness - spa, health, beauty, security, gifting, personal trainers, or well-being related requests.
# 4. Account & Finance - payments, invoices, refunds, credit cards, or profile/contact updates.
# 5. Transport & Mobility - cars, drivers, chauffeurs, limousines, or any ground transport not part of a larger travel booking.
...
#         return Metadata(user_name=None, category=None)
...
# Your task:
# 1. Identify the **user_name** mentioned in the query (if any).
# 2. Classify the query into two of these 5 categories (ordered by relevance). 
#    - If the query clearly fits only one category, return one.
#    - If it could relate to more than one, return both in a list.
#    - You have to reason to find out the second category like if a person asks what is vikram's dietery alergy then it can come in Dining & Experiences too becuase a pers & Personal & Wellness 
                                          

# Available categories:
# 1. Travel & Accommodation – hotels, flights, villas, itineraries, trip bookings, or travel arrangements.
# 2. Dining & Experiences – restaurant bookings, dietry realted stuff, concerts, cultural or social events, entertainment, or art-related experiences.
# 3. Personal & Wellness – spa, health, beauty, security, gifting, personal trainers, or well-being requests.
# 4. Account & Finance – payments, invoices, refunds, credit cards, or profile/contact updates.
# 5. Transport & Mobility – cars, drivers, chauffeurs, limousines, or any ground transport not part of a larger travel booking.
...
def extract_metadata(query: str):
    ...
    try:
        ...
        # Ensure category is always a list for downstream use
